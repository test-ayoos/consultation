...
import com.bytatech.ayoos.client.alfresco_rest_api.model.DeletedNodeBodyRestore;
import com.bytatech.ayoos.client.alfresco_rest_api.model.DeletedNodeEntry;
import com.bytatech.ayoos.client.alfresco_rest_api.model.DeletedNodesPaging;
...
public interface TrashcanApi {
    ...
    @ApiOperation(value = "Get rendition content of a deleted node", nickname = "getArchivedNodeRenditionContent", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets the rendition content for **renditionId** of file **nodeId**. ", authorizations = {
        @Authorization(value = "basicAuth")
    }, tags={ "trashcan", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Get deleted node content", nickname = "getDeletedNodeContent", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets the content of the deleted node with identifier **nodeId**. ", authorizations = {
        @Authorization(value = "basicAuth")
    }, tags={ "trashcan", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response"),
