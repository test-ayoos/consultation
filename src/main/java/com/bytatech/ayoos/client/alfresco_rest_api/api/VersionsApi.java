...
import com.bytatech.ayoos.client.alfresco_rest_api.model.RevertBody;
import com.bytatech.ayoos.client.alfresco_rest_api.model.VersionEntry;
import com.bytatech.ayoos.client.alfresco_rest_api.model.VersionPaging;
...
public interface VersionsApi {
    ...
    @ApiOperation(value = "Get version content", nickname = "getVersionContent", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets the version content for **versionId** of file node **nodeId**. ", authorizations = {
        @Authorization(value = "basicAuth")
    }, tags={ "versions", })
    @ApiResponses(value = { 
