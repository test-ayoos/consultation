...
import com.bytatech.ayoos.client.alfresco_rest_api.model.RatingBody;
import com.bytatech.ayoos.client.alfresco_rest_api.model.RatingEntry;
import com.bytatech.ayoos.client.alfresco_rest_api.model.RatingPaging;
...
public interface RatingsApi {
    ...
    @ApiOperation(value = "Create a rating", nickname = "createRating", notes = "Create a rating for the node with identifier **nodeId**", response = RatingEntry.class, authorizations = {@Authorization(value = "basicAuth")}, tags={ "ratings", })
    @ApiResponses(value = { 
