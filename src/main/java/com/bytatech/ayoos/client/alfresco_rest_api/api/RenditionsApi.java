...
import com.bytatech.ayoos.client.alfresco_rest_api.model.RenditionBodyCreate;
import com.bytatech.ayoos.client.alfresco_rest_api.model.RenditionEntry;
import com.bytatech.ayoos.client.alfresco_rest_api.model.RenditionPaging;
...
public interface RenditionsApi {
    ...
    @ApiOperation(value = "Create rendition", nickname = "createRendition", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  An asynchronous request to create a rendition for file **nodeId**.  The rendition is specified by name **id** in the request body: ```JSON {   \"id\":\"doclib\" } ``` ", authorizations = {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 409, message = "Rendition already exists"),
    ...
    ResponseEntity<Void> createRendition(@ApiParam(value = "The identifier of a node.",required=true) @PathVariable("nodeId") String nodeId,@ApiParam(value = "The renditionId" ,required=true )  @Valid @RequestBody RenditionBodyCreate renditionBodyCreate);
    ...
    @ApiOperation(value = "Get rendition content", nickname = "getRenditionContent", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets the rendition content for **renditionId** of file **nodeId**. ", authorizations = {
        @Authorization(value = "basicAuth")
    }, tags={ "renditions", })
    @ApiResponses(value = { 
