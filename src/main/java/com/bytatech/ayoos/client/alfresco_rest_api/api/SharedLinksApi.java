...
import com.bytatech.ayoos.client.alfresco_rest_api.model.SharedLinkBodyCreate;
import com.bytatech.ayoos.client.alfresco_rest_api.model.SharedLinkBodyEmail;
import com.bytatech.ayoos.client.alfresco_rest_api.model.SharedLinkEntry;
import com.bytatech.ayoos.client.alfresco_rest_api.model.SharedLinkPaging;
...
public interface SharedLinksApi {
    ...
    @ApiOperation(value = "Get shared link content", nickname = "getSharedLinkContent", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets the content of the file with shared link identifier **sharedId**.  **Note:** No authentication is required to call this endpoint. ", authorizations = {
        @Authorization(value = "basicAuth")
    }, tags={ "shared-links", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Get shared link rendition content", nickname = "getSharedLinkRenditionContent", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets the rendition content for file with shared link identifier **sharedId**.  **Note:** No authentication is required to call this endpoint. ", authorizations = {
        @Authorization(value = "basicAuth")
    }, tags={ "shared-links", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful response"),
