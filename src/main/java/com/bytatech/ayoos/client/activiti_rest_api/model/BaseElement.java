...
public class BaseElement   {
  ...
  public BaseElement id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public BaseElement xmlRowNumber(Integer xmlRowNumber) {
  ...
  **/
  ...
  public BaseElement xmlColumnNumber(Integer xmlColumnNumber) {
  ...
  **/
  ...
  public BaseElement extensionElements(Map<String, List<ExtensionElement>> extensionElements) {
    this.extensionElements = extensionElements;
    return this;
  }

  public BaseElement putExtensionElementsItem(String key, List<ExtensionElement> extensionElementsItem) {
  ...
  **/
  ...
  public BaseElement attributes(Map<String, List<ExtensionAttribute>> attributes) {
    this.attributes = attributes;
    return this;
  }

  public BaseElement putAttributesItem(String key, List<ExtensionAttribute> attributesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, baseElement.id) &&
        Objects.equals(this.xmlRowNumber, baseElement.xmlRowNumber) &&
        Objects.equals(this.xmlColumnNumber, baseElement.xmlColumnNumber) &&
        Objects.equals(this.extensionElements, baseElement.extensionElements) &&
        Objects.equals(this.attributes, baseElement.attributes);
  }
